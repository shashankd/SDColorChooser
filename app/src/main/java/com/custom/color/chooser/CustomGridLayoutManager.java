...
public class CustomGridLayoutManager extends GridLayoutManager {
    ...
    private final static String TAG = CustomGridLayoutManager.class.getSimpleName();
    ...
    public CustomGridLayoutManager(Context context, int columnWidth, int orientation, boolean reverseLayout) { /* Initially set spanCount to 1, will be changed automatically later. */
